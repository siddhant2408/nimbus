...
import { WorkspaceSlugProvider, paths } from "@nimbus/core/paths";
import { workspaceBySlugOptions } from "@nimbus/core/workspace";
import { setCurrentWorkspace } from "@nimbus/core/platform";
import { useAuthStore } from "@nimbus/core/auth";
import { NoAccessPage } from "@nimbus/views/workspace/no-access-page";
import { NimbusIcon as NimbusIcon } from "@nimbus/ui/components/common/nimbus-icon";
import { useWorkspaceSeen } from "@nimbus/views/workspace/use-workspace-seen";
...
export default function WorkspaceLayout({
  ...
  const loadingIndicator = (
    <div className="flex h-svh items-center justify-center">
      <NimbusIcon className="size-6 animate-pulse" />
    </div>
  );
