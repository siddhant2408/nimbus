...
import { captureDownloadPageViewed } from "@nimbus/core/analytics";

const ALL_RELEASES_URL =
  "https://github.com/nimbus-ai/nimbus/releases";
  ...
  return (
    <>
      {/* Positioning context for the dark-variant LandingHeader —
          mirrors nimbus-landing.tsx. The header is `absolute top-0
