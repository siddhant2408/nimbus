...
export const metadata: Metadata = {
  title: "Download Nimbus",
  description:
    "Download Nimbus for macOS, Windows, or Linux — or install the CLI for servers and remote dev boxes.",
  openGraph: {
    title: "Download Nimbus",
    description:
      "Get the Nimbus desktop app with a bundled daemon, or install the CLI for servers and remote dev boxes.",
    url: "/download",
  },
  alternates: {
    canonical: "/download",
