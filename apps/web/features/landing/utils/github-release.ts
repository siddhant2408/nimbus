...
/**
 * Server-side fetcher for the latest Nimbus release, designed to
...
const GITHUB_RELEASES_URL =
  "https://api.github.com/repos/nimbus-ai/nimbus/releases?per_page=2";
...
export async function fetchLatestRelease(): Promise<LatestRelease> {
  ...
  try {
    ...
    // Defensive filter — Nimbus doesn't publish prereleases or drafts
