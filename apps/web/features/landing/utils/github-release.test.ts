...
const SAMPLE_LATEST_ASSET = {
  name: "nimbus-desktop-0.2.14-mac-arm64.dmg",
  browser_download_url:
    "https://github.com/nimbus-ai/nimbus/releases/download/v0.2.14/nimbus-desktop-0.2.14-mac-arm64.dmg",
};

const SAMPLE_PREV_ASSET = {
  name: "nimbus-desktop-0.2.13-mac-arm64.dmg",
  browser_download_url:
    "https://github.com/nimbus-ai/nimbus/releases/download/v0.2.13/nimbus-desktop-0.2.13-mac-arm64.dmg",
};
...
function releasePayload(overrides: {
  ...
  return {
    ...
    html_url: `https://github.com/nimbus-ai/nimbus/releases/tag/${overrides.tag}`,
