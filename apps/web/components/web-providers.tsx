...
import { CoreProvider } from "@nimbus/core/platform";
...
// cookie mode on their next logout/login cycle (logout clears nimbus_token).
// Sunset: once telemetry shows <1% of sessions still carry nimbus_token,
...
function hasLegacyToken(): boolean {
  ...
  try {
    return Boolean(window.localStorage.getItem("nimbus_token"));
  } catch {
    return false;
  }
}
