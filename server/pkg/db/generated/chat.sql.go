...
RETURNING id, workspace_id, agent_id, creator_id, title, session_id, work_dir, runtime_id, status, created_at, updated_at, unread_since
`
...
SELECT id, workspace_id, agent_id, creator_id, title, session_id, work_dir, runtime_id, status, created_at, updated_at, unread_since FROM chat_session
WHERE id = $1
`
...
SELECT cs.id, cs.workspace_id, cs.agent_id, cs.creator_id, cs.title, cs.session_id, cs.work_dir, cs.runtime_id, cs.status, cs.created_at, cs.updated_at, cs.unread_since,
