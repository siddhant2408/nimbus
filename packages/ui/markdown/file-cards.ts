 ...
 *
 * Uses exact hostname match against `cdnDomain` (e.g. "nimbus-static.copilothub.ai"),
 ...
 * @param cdnDomain CDN hostname for legacy link detection (e.g. "nimbus-static.copilothub.ai")
 */
