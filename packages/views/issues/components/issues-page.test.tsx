...
import type { Issue } from "@nimbus/core/types";
...
// Mock @nimbus/views/navigation (AppLink + useNavigation)
vi.mock("../../navigation", () => ({
...
vi.mock("@nimbus/core/issues/stores/view-store", () => ({
...
vi.mock("@nimbus/core/issues/stores/view-store-context", () => ({
  ViewStoreProvider: ({ children }: { children: React.ReactNode }) => children,
  useViewStore: (selector?: any) => (selector ? selector(mockViewState) : mockViewState),
  useViewStoreApi: () => ({ getState: () => mockViewState, setState: vi.fn(), subscribe: vi.fn() }),
}));

vi.mock("@nimbus/core/issues/stores/issues-scope-store", () => ({
...
vi.mock("@nimbus/core/issues/stores/selection-store", () => ({
...
vi.mock("@nimbus/core/issues/stores/recent-issues-store", () => ({
