...
import type { Issue, TimelineEntry } from "@nimbus/core/types";

const mockViewport = vi.hoisted(() => ({ isMobile: false }));

vi.mock("@nimbus/ui/hooks/use-mobile", () => ({
  useIsMobile: () => mockViewport.isMobile,
}));

// useWorkspaceId() derives from useCurrentWorkspace (relative import inside
// @nimbus/core/hooks.tsx). vi.mock("@nimbus/core/paths") only intercepts
...
// Mock @nimbus/core/auth
const mockAuthUser = { id: "user-1", email: "test@test.com", name: "Test User" };
vi.mock("@nimbus/core/auth", () => ({
...
// Mock @nimbus/core/workspace/hooks
vi.mock("@nimbus/core/workspace/hooks", () => ({
  useActorName: () => ({
...
vi.mock("@nimbus/core/workspace/queries", () => ({
  memberListOptions: () => ({
...
// Mock @nimbus/core/paths — after the URL-driven workspace refactor,
...
vi.mock("@nimbus/core/paths", async () => {
  const actual = await vi.importActual<typeof import("@nimbus/core/paths")>(
    "@nimbus/core/paths",
  );
  return {
    ...actual,
...
// Mock issue config
vi.mock("@nimbus/core/issues/config", () => ({
...
vi.mock("@nimbus/core/issues/stores", () => ({
...
// Mock react-resizable-panels (used by @nimbus/ui/components/ui/resizable)
