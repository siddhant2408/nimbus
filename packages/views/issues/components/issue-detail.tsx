...
import { FileUploadButton } from "@nimbus/ui/components/common/file-upload-button";
import {
  Tooltip,
  TooltipTrigger,
  TooltipContent,
} from "@nimbus/ui/components/ui/tooltip";
import { Popover, PopoverTrigger, PopoverContent } from "@nimbus/ui/components/ui/popover";
import { Checkbox } from "@nimbus/ui/components/ui/checkbox";
import { Command, CommandInput, CommandList, CommandEmpty, CommandGroup, CommandItem } from "@nimbus/ui/components/ui/command";
import { AvatarGroup, AvatarGroupCount } from "@nimbus/ui/components/ui/avatar";
import { ActorAvatar } from "../../common/actor-avatar";
import { PropRow } from "../../common/prop-row";
import type { IssueStatus, IssuePriority, TimelineEntry } from "@nimbus/core/types";
import { STATUS_CONFIG, PRIORITY_CONFIG } from "@nimbus/core/issues/config";
...
import { issueListOptions, issueDetailOptions, childIssuesOptions, issueUsageOptions } from "@nimbus/core/issues/queries";
...
import { ReactionBar } from "@nimbus/ui/components/common/reaction-bar";
import { useFileUpload } from "@nimbus/core/hooks/use-file-upload";
import { api } from "@nimbus/core/api";
import { useModalStore } from "@nimbus/core/modals";
import { timeAgo } from "@nimbus/core/utils";
...
export function IssueDetail({ issueId, onDelete, onDone, defaultSidebarOpen = true, layoutId = "nimbus_issue_detail_layout", highlightCommentId }: IssueDetailProps) {
  const id = issueId;
