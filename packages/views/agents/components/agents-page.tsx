...
import type { Agent, AgentRuntime, CreateAgentRequest } from "@nimbus/core/types";
import {
...
import { DataTable } from "@nimbus/ui/components/ui/data-table";
    ...
    <PageHeader className="justify-between px-5">
      <div className="flex items-center gap-2">
        ...
        <p className="ml-2 hidden text-xs text-muted-foreground md:block">
          ...
          <a
            href="https://nimbus.ai/docs/agents"
            target="_blank"
  ...
  return (
    <div className="flex flex-1 flex-col items-center justify-center px-6 py-16 text-center">
      ...
      <p className="mt-1 max-w-md text-sm text-muted-foreground">
        ...
        run on your machine; cloud agents run on Nimbus&rsquo;s runtime.
      </p>
