...
import { agentListOptions, memberListOptions } from "@nimbus/core/workspace/queries";
import { canAssignAgent } from "@nimbus/views/issues/components";
import { api } from "@nimbus/core/api";
import { useAgentPresenceDetail, useWorkspaceAgentAvailability } from "@nimbus/core/agents";
...
import {
  ...
  chatKeys,
} from "@nimbus/core/chat/queries";
import { useCreateChatSession, useMarkChatSessionRead } from "@nimbus/core/chat/mutations";
import { useChatStore } from "@nimbus/core/chat";
...
import { createLogger } from "@nimbus/core/logger";
import type { Agent, ChatMessage, ChatPendingTask, ChatSession } from "@nimbus/core/types";
    ...
    <div className="flex flex-1 flex-col items-center justify-center gap-5 px-6 py-8">
      <div className="text-center space-y-1">
        <h3 className="text-base font-semibold">
          {agentName ? `Hi, I'm ${agentName}` : "Welcome to Nimbus"}
        </h3>
