...
import {
  ...
  CollapsibleContent,
  CollapsibleTrigger,
} from "@nimbus/ui/components/ui/collapsible";
import { ChevronRight, ChevronDown, Brain, AlertCircle, AlertTriangle } from "lucide-react";
import { useScrollFade } from "@nimbus/ui/hooks/use-scroll-fade";
import { useAutoScroll } from "@nimbus/ui/hooks/use-auto-scroll";
import { taskMessagesOptions } from "@nimbus/core/chat/queries";
import { Markdown } from "@nimbus/views/common/markdown";
import type { AgentAvailability } from "@nimbus/core/agents";
import type { ChatMessage, ChatPendingTask, TaskMessagePayload, TaskFailureReason } from "@nimbus/core/types";
import type { ChatTimelineItem } from "@nimbus/core/chat";
