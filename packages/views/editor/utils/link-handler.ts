...
import { isGlobalPath } from "@nimbus/core/paths";
...
/**
 * Open a link — internal paths dispatch nimbus:navigate, external open new tab.
 *
...
export function openLink(href: string, currentSlug?: string | null): void {
  if (href.startsWith("/")) {
    ...
    window.dispatchEvent(
      new CustomEvent("nimbus:navigate", { detail: { path } }),
    );
  } else {
