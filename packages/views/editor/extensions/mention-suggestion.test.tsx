...
import { issueKeys, PAGINATED_STATUSES } from "@nimbus/core/issues/queries";
import type { IssueStatus, ListIssuesCache } from "@nimbus/core/types";
import type { QueryClient } from "@tanstack/react-query";

// Mock the workspace id singleton — items() reads it imperatively.
vi.mock("@nimbus/core/platform", () => ({
  getCurrentWsId: () => "ws-1",
}));
