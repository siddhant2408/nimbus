...
const longRepoUrl =
  "https://github.com/nimbus-ai/a-very-long-repository-name-that-needs-a-tooltip";

vi.mock("@tanstack/react-query", () => ({
  useQuery: () => ({ data: [] }),
}));

vi.mock("@nimbus/core/projects/mutations", () => ({
  useCreateProject: () => ({ mutateAsync: vi.fn() }),
}));

vi.mock("@nimbus/core/projects", () => ({
...
vi.mock("@nimbus/ui/components/ui/popover", () => ({
...
vi.mock("@nimbus/ui/components/common/emoji-picker", () => ({
  EmojiPicker: () => null,
}));
