...
import type { Issue, IssueStatus, IssuePriority, IssueAssigneeType } from "@nimbus/core/types";
import {
  DialogContent,
  DialogTitle,
} from "@nimbus/ui/components/ui/dialog";
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
...
import { useCreateIssue, useUpdateIssue } from "@nimbus/core/issues/mutations";
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const shouldShowBacklogHint =
        ...
        localStorage.getItem("nimbus:backlog-agent-hint-dismissed") !== "true";
        ...
        {backlogHintIssueId ? (
          <BacklogAgentHintContent
            ...
            onDismissPermanently={() => {
              localStorage.setItem("nimbus:backlog-agent-hint-dismissed", "true");
            }}
            onMoveToTodo={() => {
...
import { Dialog as DialogRoot } from "@nimbus/ui/components/ui/dialog";
