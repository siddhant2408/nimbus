...
vi.mock("@nimbus/core/issues/queries", () => ({
...
vi.mock("@nimbus/core/issues/stores/draft-store", () => ({
...
vi.mock("@nimbus/core/issues/stores/quick-create-store", () => ({
  useQuickCreateStore: (selector?: (state: typeof mockQuickCreateStore) => unknown) =>
    (selector ? selector(mockQuickCreateStore) : mockQuickCreateStore),
}));

vi.mock("@nimbus/core/issues/mutations", () => ({
...
vi.mock("@nimbus/ui/components/ui/dialog", () => ({
...
vi.mock("@nimbus/ui/components/ui/dropdown-menu", () => ({
...
vi.mock("@nimbus/ui/components/ui/tooltip", () => ({
  Tooltip: ({ children }: { children: React.ReactNode }) => <>{children}</>,
  TooltipTrigger: ({ render }: { render: React.ReactNode }) => <>{render}</>,
  TooltipContent: ({ children }: { children: React.ReactNode }) => <>{children}</>,
}));

vi.mock("@nimbus/ui/components/ui/button", () => ({
  Button: ({
    children,
    disabled,
    onClick,
...
vi.mock("@nimbus/ui/components/ui/switch", () => ({
  Switch: ({
    checked,
    onCheckedChange,
  }: {
...
vi.mock("@nimbus/ui/components/common/file-upload-button", () => ({
