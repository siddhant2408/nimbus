...
import type { AgentRuntime } from "@nimbus/core/types";
import { DragStrip } from "@nimbus/views/platform";
...
function CliWaitingStatus({ dialogOpen }: { dialogOpen: boolean }) {
  ...
  // Stage thresholds are rough — `nimbus setup` typical flow is
      ...
      >
        {stage === "normal" && (
          <>
            ...
            <span className="font-mono">nimbus setup</span> finishes
        ...
        {stage === "midway" && (
          <>
            ...
            <span className="font-mono">nimbus setup</span> opened — it
        ...
        {stage === "slow" && (
          <>
            ...
            <span className="font-mono">nimbus setup</span> for errors.
          </>
        )}
        {stage === "stalled" && (
          <>
