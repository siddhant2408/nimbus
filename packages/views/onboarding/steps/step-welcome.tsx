...
import { NimbusIcon } from "@nimbus/ui/components/common/nimbus-icon";
import { captureDownloadIntent } from "@nimbus/core/analytics";
        ...
        <div className="flex flex-1 flex-col justify-center px-6 pb-12 sm:px-10 md:px-20 lg:px-20 xl:px-24">
          <div className="flex w-full max-w-[540px] flex-col gap-8">
            <div className="flex items-center gap-2.5">
              <NimbusIcon className="size-5 text-foreground" noSpin />
