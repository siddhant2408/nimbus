...
import {
  ...
  InputOTPGroup,
  InputOTPSlot,
} from "@nimbus/ui/components/ui/input-otp";
...
import type { User } from "@nimbus/core/types";
  ...
  const handleCliAuthorize = async () => {
    ...
    try {
      ...
      if (authSourceRef.current === "localStorage") {
        ...
        const stored = localStorage.getItem("nimbus_token");
      ...
      <div className="flex min-h-svh items-center justify-center">
        <Card className="w-full max-w-sm">
          <CardHeader className="text-center">
            ...
            <CardDescription>
              Allow the CLI to access Nimbus as{" "}
