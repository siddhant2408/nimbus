...
import type { RuntimeUpdateStatus } from "@nimbus/core/types";

const GITHUB_RELEASES_URL =
  "https://api.github.com/repos/nimbus-ai/nimbus/releases/latest";
      ...
      <div className="flex items-center gap-2 flex-wrap">
        ...
        {isManaged ? (
          <span
            ...
            title="The CLI binary is managed by Nimbus Desktop — update Desktop to upgrade the CLI."
          >
            Managed by Desktop
          </span>
        ) : (
