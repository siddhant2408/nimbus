...
import { runtimeKeys } from "@nimbus/core/runtimes/queries";
import { useWSEvent } from "@nimbus/core/realtime";
import { paths, useWorkspaceSlug } from "@nimbus/core/paths";
import {
  Dialog,
  DialogContent,
  DialogDescription,
...
const INSTALL_CMD = "curl -fsSL https://raw.githubusercontent.com/nimbus-ai/nimbus/main/scripts/install.sh | bash";

const CONFIGURE_CMD = `nimbus config set server_url https://api.nimbus.ai
nimbus config set app_url https://nimbus.ai`;

const LOGIN_CMD = "nimbus login --token <YOUR_TOKEN>";

const START_CMD = `nimbus daemon start --device-name "my-ec2-instance"
    ...
    <>
      <DialogHeader>
        ...
        <DialogDescription>
          ...
          Nimbus CLI and register it as a runtime.
        </DialogDescription>
      </DialogHeader>
