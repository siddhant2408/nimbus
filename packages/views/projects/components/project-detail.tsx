...
import type { Issue, IssueStatus, ProjectStatus, ProjectPriority } from "@nimbus/core/types";
import { useAuthStore } from "@nimbus/core/auth";
import { projectDetailOptions } from "@nimbus/core/projects/queries";
import { useUpdateProject, useDeleteProject } from "@nimbus/core/projects/mutations";
import { pinListOptions } from "@nimbus/core/pins";
import { useCreatePin, useDeletePin } from "@nimbus/core/pins";
import { myIssueListOptions, childIssueProgressOptions, type MyIssuesFilter } from "@nimbus/core/issues/queries";
import { useUpdateIssue } from "@nimbus/core/issues/mutations";
import { memberListOptions, agentListOptions } from "@nimbus/core/workspace/queries";
import { useWorkspaceId } from "@nimbus/core/hooks";
import { useCurrentWorkspace, useWorkspacePaths } from "@nimbus/core/paths";
import { useActorName } from "@nimbus/core/workspace/hooks";
import { PROJECT_STATUS_ORDER, PROJECT_STATUS_CONFIG, PROJECT_PRIORITY_ORDER, PROJECT_PRIORITY_CONFIG } from "@nimbus/core/projects/config";
import { BOARD_STATUSES } from "@nimbus/core/issues/config";
import { createIssueViewStore } from "@nimbus/core/issues/stores/view-store";
import { ViewStoreProvider, useViewStore } from "@nimbus/core/issues/stores/view-store-context";
...
import { Skeleton } from "@nimbus/ui/components/ui/skeleton";
import { Button } from "@nimbus/ui/components/ui/button";
import { ResizablePanelGroup, ResizablePanel, ResizableHandle } from "@nimbus/ui/components/ui/resizable";
import { Sheet, SheetContent } from "@nimbus/ui/components/ui/sheet";
import { useIsMobile } from "@nimbus/ui/hooks/use-mobile";
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
  ...
  DropdownMenuTrigger,
} from "@nimbus/ui/components/ui/dropdown-menu";
import {
  Popover,
  PopoverTrigger,
  PopoverContent,
} from "@nimbus/ui/components/ui/popover";
import {
  Tooltip,
  TooltipTrigger,
  TooltipContent,
} from "@nimbus/ui/components/ui/tooltip";
import { EmojiPicker } from "@nimbus/ui/components/common/emoji-picker";
...
import {
  ...
  AlertDialogHeader,
  AlertDialogTitle,
} from "@nimbus/ui/components/ui/alert-dialog";
...
export function ProjectDetail({ projectId }: { projectId: string }) {
  ...
  const { defaultLayout, onLayoutChanged } = useDefaultLayout({
    id: "nimbus_project_detail_layout",
  });
