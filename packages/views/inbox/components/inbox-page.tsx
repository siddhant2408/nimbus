...
import {
  ...
  useInboxUnreadCount,
} from "@nimbus/core/inbox/queries";
import {
  useMarkInboxRead,
  useArchiveInbox,
  useMarkAllInboxRead,
...
} from "@nimbus/core/inbox/mutations";
...
import type { InboxItem } from "@nimbus/core/types";
import { Button } from "@nimbus/ui/components/ui/button";
import {
  ResizablePanelGroup,
  ResizablePanel,
  ResizableHandle,
} from "@nimbus/ui/components/ui/resizable";
...
export function InboxPage() {
  ...
  const detailContent = selected?.issue_id ? (
    ...
    <IssueDetail
      ...
      layoutId="nimbus_inbox_issue_detail_layout"
