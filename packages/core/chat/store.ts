...
const AGENT_STORAGE_KEY = "nimbus:chat:selectedAgentId";
const SESSION_STORAGE_KEY = "nimbus:chat:activeSessionId";
/** Drafts are stored as one JSON blob per workspace: { [sessionId]: text }. */
const DRAFTS_KEY = "nimbus:chat:drafts";
/** Placeholder sessionId for a chat that hasn't been created yet. */
export const DRAFT_NEW_SESSION = "__new__";
const CHAT_WIDTH_KEY = "nimbus:chat:width";
const CHAT_HEIGHT_KEY = "nimbus:chat:height";
const CHAT_EXPANDED_KEY = "nimbus:chat:expanded";
/** Focus mode is a personal preference — global across workspaces/sessions. */
const FOCUS_MODE_KEY = "nimbus:chat:focusMode";
/**
 ...
 */
const OPEN_KEY = "nimbus:chat:isOpen";
